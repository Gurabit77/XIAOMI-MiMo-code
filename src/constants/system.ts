...
const DEFAULT_PREFIX = `You are MiMo Code, a Xiaomi MiMo powered AI coding assistant CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are MiMo Code, a Xiaomi MiMo powered AI coding assistant CLI, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a MiMo agent, built on Xiaomi's MiMo model.`
