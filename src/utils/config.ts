...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when MiMo Code was first started on this machine
  ...
  // MiMo Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first MiMo Code OAuth token
  ...
  // MiMo Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
