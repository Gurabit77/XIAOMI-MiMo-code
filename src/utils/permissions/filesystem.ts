...
// Always ask when MiMo Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by MiMo Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by MiMo Code)
