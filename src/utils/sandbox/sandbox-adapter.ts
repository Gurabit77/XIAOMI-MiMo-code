...
/**
 * Resolve MiMo Code-specific path patterns for sandbox-runtime.
 *
 * MiMo Code uses special path prefixes in permission rules:
...
/**
 * Convert MiMo Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where MiMo Code started)
