...
export const MACOS_BUNDLE_ID = 'com.anthropic.mimo-code-url-handler'
const APP_NAME = 'MiMo Code URL Handler'
const DESKTOP_FILE_NAME = 'mimo-code-url-handler.desktop'
const MACOS_APP_NAME = 'MiMo Code URL Handler.app'
